...
const modalParaNo1 = 'Такой способ поздароваться с тобой и познакомить тебя с моей работой мне более по душе (сравнивая с видео презентацией).';
...
const modalListLabel = 'В пулреквесте, в принципе, самопроверка расписана. Ниже я перечислю то, на что хочу обратить внимание:';
...
const modalListItemNo4 = 'Более того, слайдер свайпится. Попробуй свайпить картинки на своем телефоне или планшете;';
const modalListItemNo5 =
  'На десктоптных размерах экрана в разделе Latest articles на картинках в слайдере старался реализовать анимацию, чтобы заставить пользователя обратить внимание на текст, который является ссылками;';
